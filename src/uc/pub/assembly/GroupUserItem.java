 ...
 * @version 1.0
 */
public class GroupUserItem extends JPanel{
    /**
	 * 
	 */
	...
	//构建
	public GroupUserItem(FriendItemModel model){
		...
		//群名称
		gname = new JLabel(this.model.getNickName());
	...
	private static final MouseAdapter mutualExclusion = new MouseAdapter(){
		...
		private GroupUserItem lastItem = new GroupUserItem(
				new FriendItemModel(img,null,null,true,null,null,null));
		public void mousePressed(MouseEvent e){
			GroupUserItem pressItem = (GroupUserItem) e.getSource();
